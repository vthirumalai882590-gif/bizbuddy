...
const seedDatabase = async () => {
    try {
        ...
        await mongoose_1.default.connection.db?.collection('expenses').deleteMany({ userId });
        await mongoose_1.default.connection.db?.collection('income').deleteMany({ userId });
        await mongoose_1.default.connection.db?.collection('receipts').deleteMany({ userId });
        await mongoose_1.default.connection.db?.collection('websites').deleteMany({ userId });
        ...
        await (0, database_1.saveIncome)(syntheticIncome, userId);
        ...
        await (0, database_1.saveExpenses)(syntheticExpenses, userId);
        ...
        await (0, database_1.saveReceipts)(syntheticReceipts, userId);
        ...
        await (0, database_1.saveWebsiteConfig)(syntheticWebsite, userId);
