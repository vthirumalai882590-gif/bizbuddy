                  ...
                  income.map((i: Income) => (
                    <tr key={i.id} className="hover:bg-slate-50/30 transition">
                      ...
                      <td className="px-5 py-3 text-center">
                        <button onClick={() => deleteSalesMutation.mutate(i.id)} disabled={deleteSalesMutation.isPending} className="text-gray-300 hover:text-red-500 transition p-1 hover:bg-red-50 rounded-lg cursor-pointer">
                          <Trash2 size={13} />
                        </button>
                      </td>
                    </tr>
                ...
                {expenses.length === 0 ? (
                  ...
                  expenses.map((e: Expense) => (
                    <tr key={e.id} className="hover:bg-slate-50/30 transition">
                      ...
                      <td className="px-5 py-3 text-center">
                        <button onClick={() => deleteExpenseMutation.mutate(e.id)} disabled={deleteExpenseMutation.isPending} className="text-gray-300 hover:text-red-500 transition p-1 hover:bg-red-50 rounded-lg cursor-pointer">
                          <Trash2 size={13} />
                        </button>
                      </td>
                    </tr>
