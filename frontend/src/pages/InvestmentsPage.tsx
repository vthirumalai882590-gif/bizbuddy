                ...
                filtered.map((e: Expense) => (
                  <tr key={e.id} className="hover:bg-slate-50/50 transition">
                    ...
                    <td className="px-5 py-4 text-center">
                      <button onClick={() => deleteMutation.mutate(e.id)} disabled={deleteMutation.isPending} className="text-gray-300 hover:text-red-500 transition p-1.5 hover:bg-red-50 rounded-xl cursor-pointer disabled:opacity-30 inline-block">
                        <Trash2 size={14} />
                      </button>
                    </td>
                  </tr>
